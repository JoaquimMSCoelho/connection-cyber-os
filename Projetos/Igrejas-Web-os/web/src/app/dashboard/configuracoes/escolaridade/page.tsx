...
import { ArrowLeft, Loader2, Trash2, GraduationCap, AlertCircle } from "lucide-react";
...
export default function EscolaridadeConfigPage() {
  ...
  async function handleDelete(id: string) {
    if (!confirm("Atenção: Tem certeza que deseja excluir esta escolaridade do sistema?")) return;
    ...
    <div className="max-w-[1200px] mx-auto space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500 pb-10">
      ...
      <div className="bg-neutral-900 border border-neutral-800 rounded-2xl p-6 shadow-xl flex flex-col lg:flex-row lg:items-center justify-between gap-6">
        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-xl font-black text-white tracking-tight uppercase">ESCOLARIDADE</h1>
          </div>
        </div>

        {/* DIREITA: Input e Botão Cadastrar */}
