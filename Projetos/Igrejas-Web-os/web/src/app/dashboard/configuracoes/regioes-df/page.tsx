...
import { ArrowLeft, Loader2, Trash2, MapPin, AlertCircle } from "lucide-react";
...
export default function RegioesDfConfigPage() {
  ...
  async function fetchItems() {
    ...
    // INJEÇÃO FUNCIONAL: Filtro restaurado para trazer apenas RAs do DF
  ...
  async function handleDelete(id: string) {
    if (!confirm("Atenção: Tem certeza que deseja excluir esta região do sistema? Pode impactar cadastros existentes.")) return;
