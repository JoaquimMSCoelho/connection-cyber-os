...
import { ArrowLeft, Loader2, Trash2, Users, AlertCircle } from "lucide-react";
...
export default function GeneroConfigPage() {
  ...
  // INJEÇÃO FUNCIONAL: Chave original mantida (settings_gender)
  ...
  async function handleDelete(id: string) {
    if (!confirm("Atenção: Tem certeza que deseja excluir este gênero do sistema?")) return;
