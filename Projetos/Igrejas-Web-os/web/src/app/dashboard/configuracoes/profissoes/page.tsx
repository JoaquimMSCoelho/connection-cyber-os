...
import { ArrowLeft, Loader2, Trash2, UserSquare2, AlertCircle } from "lucide-react";
...
export default function ProfissoesConfigPage() {
  ...
  // INJEÇÃO FUNCIONAL: Chave original mantida (settings_professions)
  ...
  async function handleDelete(id: string) {
    if (!confirm("Atenção: Tem certeza que deseja excluir esta profissão do sistema?")) return;
